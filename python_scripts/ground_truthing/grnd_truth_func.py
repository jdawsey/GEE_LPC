...
def stdrd_ref_func(given_shp):
    shp = given_shp # list
    
    year = ee.ImageCollection('USDA/NAIP/DOQQ').filterDate('2022-01-01', '2022-12-31').filterBounds(shp)
...
def obj_class(given_shp, given_segmented, max_clusters):
