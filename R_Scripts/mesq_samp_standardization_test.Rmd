...
shp <- eeItemList[[2]] # change per buffer ########### currently standardizing. Haven't run 2
#Have downloaded 1, 10, and 45 for testing
...
dog <- fat$add(skinny)
sharpened <- standardized$add(standardized$convolve(dog))
###
...
clusterer <- ee$Clusterer$wekaXMeans() %>% # change clusters depending on imagery ### check accuracies
